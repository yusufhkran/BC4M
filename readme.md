...
### Deploy kısmında izlediğim adımlar:
 ...
 #### Son olarak Gateways, Services & Ingress kısmından oluşturduğum servisin endpoint kısmından oluşturulan ip adresine giriş yaptım ve {"msg": "BC4M"} yazısını gördüm. /health isteği gönderip durumunu kontrol ettim. Postman ile body den gelen post istekleri atıp kontrolleri gerçekleştirdim ve herhangi bir sıkıntıyla karşılaşmadım. 
